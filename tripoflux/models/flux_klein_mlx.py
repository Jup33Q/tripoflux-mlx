...
class FluxKleinGenerator:
    ...
    def _generate_mflux(self, cfg: FluxGenerationConfig) -> Optional[Image.Image]:
    ...
    def _generate_diffusers(self, cfg: FluxGenerationConfig) -> Optional[Image.Image]:
    ...
    # Public API
    # ------------------------------------------------------------------
    def generate(self, cfg: FluxGenerationConfig) -> Image.Image:
